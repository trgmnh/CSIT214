...
export default function Navbar() {
    ...
    return <nav className="bg-white shadow-md py-4 border-b border-gray-200"> 
        <div className="container mx-auto flex justify-between items-center px-6 lg:px-8">
            <Link href={"/"}> 
               <Image src={"/flydreamair_logo_dark.png"} alt="logo" width={150} height={50}/> 
               
            </Link>

            <div className="flex items-center space-x-4">
                <Link href={"/trips"} className="text-slate-900 hover:text-sky-500">Plan your trip </Link>
                <Link href={"/info"} className="text-slate-900 hover:text-sky-500">Information</Link>
                <Link href={"/booking"} className="text-slate-900 hover:text-sky-500">Your Booking</Link>
                <Link href={"/about"} className="text-slate-900 hover:text-sky-500">About</Link>
                <Link href={"/help"} className="text-slate-900 hover:text-sky-500">Help</Link>
